...
station, region, altitude, latitude, longitude = 'Brocken', 'Saxony-Anhalt', 1135, 10.6183, 51.7986    # station name, region, altitude, latitude, longitude
...
src = 'D:\education\BTU\landsurface\github project\Walter-Lieth-climate-diagram\produkt_klima_tag_18960101_20191231_00722.txt'        # path to the data file
src_data_OB=src
...
#fig.savefig('ex_2.1_Brocken_WL_Diagram.png',dpi=300, bbox_inches='tight')
plt.show()