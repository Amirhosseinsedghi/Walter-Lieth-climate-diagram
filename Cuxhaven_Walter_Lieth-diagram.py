...
station, region, altitude, latitude, longitude = 'Cuxhaven','Niedersachsen', 5, 53.8713, 8.7060   # station name, region, altitude, latitude, longitude
...
src = 'D:\education\BTU\landsurface\github project\Walter-Lieth-climate-diagram\produkt_klima_tag_19460101_20191231_00891 (1).txt'        # path to the data file
src_data_OB=src
